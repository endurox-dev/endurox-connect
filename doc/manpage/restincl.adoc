...
- *EX_IF_REQFORMN* - form submit field name;

- *EX_IF_REQFORMV* - form submit field value;
...
system will attempt to return the *EX_NETDATA*.
...
pairs are filled. In this case *EX_NETDATA* field is not setup. This flag functions
