...
For our sample purposes this will the library function will call the database stored
procedure to which XML will be passed in and stored procedure will provide XML back.
The XML will be mapped to UBF buffer and used for marshal/unmarshal to FML.
