...
$ mkdir -p ${NDRX_APPHOME}/xa/rm1_dblogs
...
# XA Config
NDRX_XA_RES_ID=1
NDRX_XA_OPEN_STR=ORACLE_XA+SqlNet=<SID>+ACC=P/<DBUSER>/<DBPASS>+SesTM=180+LogDir=${NDRX_APPHOME}/xa/rm1_dblogs+nolocal=f+Threads=true
NDRX_XA_CLOSE_STR=ORACLE_XA+SqlNet=<SID>+ACC=P/<DBUSER>/<DBPASS>+SesTM=180+LogDir=${NDRX_APPHOME}/xa/rm1_dblogs+nolocal=f+Threads=true
...
useful info can be found also in  xa_NULLMMDDYYYY.trc files, in ${NDRX_APPHOME}/xa/rm1_dblogs
folder.

=== Adding Enduro/X environment as default for user

---------------------------------------------------------------------------------
$ echo "source /enduro/conf/settrb" >> ~/.bashrc
---------------------------------------------------------------------------------
...
su trb -c 'source /enduro/conf/settrb; xadmin start -y'
EOF
...
su trb -c 'source /enduro/conf/settrb; xadmin stop -c -y'
EOF
