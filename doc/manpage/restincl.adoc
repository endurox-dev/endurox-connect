...
Conversion buffer type: 'json2viiew' - JSON converted to VIEW message handling
------------------------------------------------------------------------------
...
response buffer (converted to JSON) is returned. Default is *false*.

*errfmt_view_notnull* = 'ERRFMT_VIEW_NOTNULL'::
