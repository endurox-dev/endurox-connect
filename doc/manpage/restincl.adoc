...
. atmi.TPMINVAL ()=  http.StatusOK
. atmi.TPEABORT ()= http.StatusInternalServerError
. atmi.TPEBADDESC ()=  http.StatusBadRequest
. atmi.TPEBLOCK ()=  http.StatusInternalServerError
. atmi.TPEINVAL ()=  http.StatusBadRequest
. atmi.TPELIMIT() =  http.StatusRequestEntityTooLarge
. atmi.TPENOENT ()=  http.StatusNotFound
. atmi.TPEOS ()=  http.StatusInternalServerError
. atmi.TPEPERM ()=  http.StatusUnauthorized
. atmi.TPEPROTO ()=  http.StatusBadRequest
. atmi.TPESVCERR ()=  http.StatusBadGateway
. atmi.TPESVCFAIL ()=  http.StatusInternalServerError
. atmi.TPESYSTEM ()=  http.StatusInternalServerError
. atmi.TPETIME ()=  http.StatusGatewayTimeout
. atmi.TPETRAN ()=  http.StatusInternalServerError
. atmi.TPERMERR ()=  http.StatusInternalServerError
. atmi.TPEITYPE ()=  http.StatusInternalServerError
. atmi.TPEOTYPE ()=  http.StatusInternalServerError
. atmi.TPERELEASE ()=  http.StatusInternalServerError
. atmi.TPEHAZARD ()=  http.StatusInternalServerError
. atmi.TPEHEURISTIC ()=  http.StatusInternalServerError
. atmi.TPEEVENT ()=  http.StatusInternalServerError
. atmi.TPEMATCH ()=  http.StatusInternalServerError
. atmi.TPEDIAGNOSTIC ()=  http.StatusInternalServerError
. atmi.TPEMIB ()=  http.StatusInternalServerError
